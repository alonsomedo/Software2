<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ReporteMedicamentoVencimiento.aspx.cs" Inherits="SAVM.ReporteMedicamentoVencimiento" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <h3>Reporte de Medicamentos Proximos a Vencer</h3>
        <br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    ...
    <script src="js/ReporteMedicamentosVencimiento.js"></script>
</asp:Content>
